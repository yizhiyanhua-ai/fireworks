...
export const featuredProjects = [
  {
    ...
    tagline: 'Prompt-to-diagram + semantic motion 技术图生成器',
    useCase: '架构评审 / 云部署 / 事件流 / 可观测性 / Agent 系统',
    outcome: '把自然语言里的工程系统变成几何安全的技术图，再让线束从空画面渐进出现，并在最终画面持续流动。',
    launchRank: '#1',
    upvotes: '8.3k',
    previewType: 'diagram',
    previewImage: '/fireworks/assets/product-tech-graph-motion-showcase.gif',
    previewStaticImage: '/fireworks/assets/product-tech-graph-cloud-fabric.png',
    previewAlt: 'fireworks-tech-graph v1.2.0 十二种风格 SVG 转 GIF 动效总览',
    previewSource: 'v1.2.0: 12 styles / draw-on / settled data flow',
    highlights: ['12 种风格共享语义动效契约', '线条渐进出现，最终持续数据流', '852 / 852 浏览器兼容帧通过'],
    description:
      '用自然语言生成通过几何与工程语义门禁的技术图。v1.2.0 聚焦语义 SVG→GIF：结构先被画出来，再进入延长两秒的稳定数据流阶段；12 种独立场景使用同一套 fail-closed 质量门禁。',
    url: 'https://github.com/yizhiyanhua-ai/fireworks-tech-graph',
    demo: 'https://yizhiyanhua-ai.github.io/fireworks-tech-graph/',
    stars: 8812,
    forks: 757,
    language: 'Python',
    tags: ['AI diagrams', 'Semantic motion', 'SVG to GIF'],
    accent: 'blue',
    flagship: true,
  },
  {
